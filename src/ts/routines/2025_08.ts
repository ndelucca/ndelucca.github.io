// August 2025 routine data - extracted from routines/2025_08.md
...
export const getTotalWeeks = (): number => {
  return Math.max(...routine2025_08.workoutDays.map(w => w.week));
};

export const getTotalWorkoutDays = (): number => {
  return routine2025_08.workoutDays.length;
};
